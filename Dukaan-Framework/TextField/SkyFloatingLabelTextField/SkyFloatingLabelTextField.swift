...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    @objc dynamic open var titleFadeInDuration: TimeInterval = 0.1
    ...
    dynamic open var customDisable: Bool = false {
        didSet {
            updateTitleColor()
        }
    }
    ...
    var customTitleColor: UIColor = .black50
    var customTextColor: UIColor = .textPrimary
    ...
    */
    ...
    open var hasErrorMessage: Bool { errorMessage != nil && !(errorMessage?.isEmpty ?? true) }
    ...
    */
    ...
    fileprivate func updateTitleColor() {
        ...
        if !isEnabled {
            titleLabel.textColor = customDisable ? customTitleColor : disabledColor
            ...
            if editingOrSelected || isHighlighted {
                ...
                titleLabel.textColor = customDisable ? customTitleColor : titleColor
            }
        }
    }
    ...
    fileprivate func updateTextColor() {
        if !isEnabled {
            super.textColor = customDisable ? customTextColor : disabledColor
        } else if hasErrorMessage {
    ...
    */
    ...
    func setCustomDisableColorsWhenDisable( customTitleColor: UIColor, customTextColor: UIColor) {
        customDisable = true
        self.titleColor = customTitleColor
