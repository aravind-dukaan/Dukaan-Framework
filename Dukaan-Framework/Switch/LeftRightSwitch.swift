...
protocol LeftRightSwitchDelegate: AnyObject {
    func switchDidChangeValue(toggleSwitch: LeftRightSwitch, value: Bool)
}

class LeftRightSwitch: UIView {
    ...
    weak var delegate: LeftRightSwitchDelegate?
